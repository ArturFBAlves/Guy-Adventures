...
public class NPC_Archangel extends Entity {
    ...
    public void getImage() {
        up1 = setup("/npc/archangel_up_1");
        up2 = setup("/npc/archangel_up_2");
        down1 = setup("/npc/archangel_down_1");
        down2 = setup("/npc/archangel_down_2");
        left1 = setup("/npc/archangel_left_1");
        left2 = setup("/npc/archangel_left_2");
        right1 = setup("/npc/archangel_right_1");
        right2 = setup("/npc/archangel_right_2");
    }
}